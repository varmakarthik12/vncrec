...
vnc-recorder --host myhost --mp4-max-duration 3600

# High quality MP4 at 60fps
vnc-recorder --host myhost --framerate 60 --crf 20

# HLS with 1-day retention
vnc-recorder --host myhost --format hls --hls-max-duration 86400

# HLS with 10-second segments for lower latency
vnc-recorder --host myhost --format hls --hls-segment-duration 10
...
```bash
vnc-recorder daemon --host myhost --password secret

# Aliases
vnc-recorder d --host myhost
vnc-recorder watch --host myhost
```
